...
function USAGE {
    'Usage:'
    ' sharepoint_backup.ps1 [-siteurl] <URL> [-destination] <PATH>'
    '   [-days <INT>] [-hours <INT>] [-whatif]'
    'E.G:'
    ' Back up all sites that have been modified in the last 25 hours:'
    ' sharepoint_backup.ps1 https://sharepoint.uvm.edu -destination' +
    ' E:\backup -hours 25'
    ''
    return
}
...
$LIBRARY_SPBACKUP   = join-path $SCRIPTHOME 'Library-SPBackup.ps1'
...
# Load Sharepoint .NET Assembly, defined in $LIBRARY...
